...
router.route("/campaign/category/:id").get(staffController.getCampaignByCategory);
...
router.route("/submit_idea/upload").post(upload.upload, staffController.createIdea);
